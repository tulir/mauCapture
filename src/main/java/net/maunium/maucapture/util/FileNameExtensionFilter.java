...
public final class FileNameExtensionFilter extends FileFilter {
	 ...
	 * @throws IllegalArgumentException if extensions is {@code null}, empty, contains {@code null}, or contains an
	 *                                  empty string
	 * @see #accept
	 */
	 ...
	 * extension matches one of the file name extensions of this {@code FileFilter}, or the file is a directory.
	 *
	...
	/**
	 * Returns a string representation of the {@code FileNameExtensionFilter}. This method is intended to be used for
	 * debugging purposes, and the content and format of the returned string may vary between implementations.
	 *
